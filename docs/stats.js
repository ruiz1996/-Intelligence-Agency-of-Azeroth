...
export function heroDefinition(s,id) {
  const h=HERO_BY_ID[id],form=heroForm(s,id);return form?{...h,active:h.forms[form].active,passive:h.forms[form].passive,form,formName:h.forms[form].name}:h;
}
export function heroStats(s,id) {
  ...
  result.attackBase=h.base.atk*(1+.16*(record.star-1))+flat.atk;
