...
export function archiveClues(h,s){
  const known=new Set([...(s.firsts||[]),...(s.historyContribution||[])]),index=HEROES.indexOf(h);
...
export function revealStyle(h){const basic=HEROES.indexOf(h)<5;return {kind:basic?'standard':'signature',color:basic?'#79bfc0':['#bd9ee6','#e3b36d','#82c7b2','#86b7e2'][HEROES.indexOf(h)%4],label:basic?'基础档案':'专属档案'};}
