// Adopted September 16: Xiaocheng v0.10 and Bandebeidiwang v0.9 recommended values.
...
export function applyHeroRework(hero){
  ...
  if(hero.id==='bandebeidiwang')return {...hero,
    active:{...hero.active,directAtkCoefficient:.5,singleTargetLayers:2,
      dot:{...hero.active.dot,tickAtkCoefficient:.45,perTargetOwnInstances:null,sameSourceRefresh:false}},
